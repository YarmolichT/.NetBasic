...
GO
PRINT N'Идет создание Таблица [dbo].[Address]…';
...
GO
PRINT N'Идет создание Таблица [dbo].[Person]…';
...
GO
PRINT N'Идет создание Внешний ключ [dbo].[FK_Company_Address]…';


GO
ALTER TABLE [dbo].[Company]
    ADD CONSTRAINT [FK_Company_Address] FOREIGN KEY ([AddressId]) REFERENCES [dbo].[Address] ([Id_Address]);


GO
PRINT N'Идет создание Внешний ключ [dbo].[FK_Employee_Person]…';


GO
ALTER TABLE [dbo].[Employee]
    ADD CONSTRAINT [FK_Employee_Person] FOREIGN KEY ([PersonId]) REFERENCES [dbo].[Person] ([Id_Person]);


GO
PRINT N'Идет создание Внешний ключ [dbo].[FK_Employee_Address]…';


GO
ALTER TABLE [dbo].[Employee]
    ADD CONSTRAINT [FK_Employee_Address] FOREIGN KEY ([AddressId]) REFERENCES [dbo].[Address] ([Id_Address]);
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '9db4767b-55e1-41c9-b19f-048137d23ab9')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('9db4767b-55e1-41c9-b19f-048137d23ab9')
...
INSERT dbo.[Address]
VALUES 
('Dziarzhinskogo', 'Minsk', 'Malinovka', '10101'),
('Minskaya', 'Moscow', 'Centralny', '00702')
...
INSERT dbo.[Employee]
VALUES 
('EPAM', 'Dev', 'Tatsiana', 1, 1),
('Andersen', 'BA', 'Kate', 2, 2)
GO
