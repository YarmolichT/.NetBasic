...
namespace NorthwindTraders.Data.Migrations
{
    ...
    [Migration("20230817110242_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NorthwindTraders.Data.EmployeeTerritories", b =>
                {
                    b.Property<int>("EmployeeId")
                        .HasColumnName("EmployeeID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NorthwindTraders.Data.OrderDetails", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnName("OrderID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NorthwindTraders.Data.Employee", b =>
                {
                    b.HasOne("NorthwindTraders.Data.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("NorthwindTraders.Data.Order", b =>
                {
                    ...
                    b.HasOne("NorthwindTraders.Data.Shipper", "ShipViaNavigation")
                        .WithMany("Orders")
